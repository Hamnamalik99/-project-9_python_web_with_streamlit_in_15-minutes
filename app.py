...
# About Us
    ...
    st.write("Our curriculum is designed to meet industry standards and prepare you for professional Python development.")  # More information about the curriculum
    
    st.image("https://www.python.org/static/community_logos/python-logo.png", width=300)  # Displaying the Python logo again for branding
    
    # Expert Team
    st.subheader("👨‍💼 Our Expert Team")  # Subheader for the expert team section
    col1, col2, col3 = st.columns(3)  # Creating three columns for displaying expert team members
    with col1:  # First column for expert 1
        st.write("**Dr. John Smith, PhD**")  # Expert's name and designation
        st.write("Chief Technical Advisor")  # Expert's role
        
    with col2:  # Second column for expert 2
        st.write("**Sarah Johnson, MSc**")  # Expert's name and designation
        st.write("Lead Python Architect")  # Expert's role
        
    with col3:  # Third column for expert 3
        st.write("**Michael Chen, MBA**")  # Expert's name and designation
        st.write("Enterprise Solutions Director")  # Expert's role

st.markdown("---")  # Horizontal line for separation
st.markdown("Professional Python Development 🐍")  # Footer text

# Professional Footer
st.sidebar.markdown("---")  # Horizontal line in the sidebar for separation
st.sidebar.write("📧 Contact: hamnamalik@gmail.com")  # Displaying the contact email
st.sidebar.write("🌐 Follow us on LinkedIn")  # Displaying a link to LinkedIn
st.sidebar.write("📱 Join our professional network")  # Encouraging users to join the professional network
st.markdown("<div class='footer'>Made by ❤️ Hamna Malik</div>", unsafe_allow_html=True)